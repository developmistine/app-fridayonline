...
//
//     final getProductByCategoryBanner = getProductByCategoryBannerFromJson(jsonString);

// import 'package:meta/meta.dart';
import 'dart:convert';

GetProductByCategoryBanner getProductByCategoryBannerFromJson(String str) =>
    GetProductByCategoryBanner.fromJson(json.decode(str));

String getProductByCategoryBannerToJson(GetProductByCategoryBanner data) =>
    json.encode(data.toJson());

class GetProductByCategoryBanner {
  GetProductByCategoryBanner({
    required this.skucode,
    required this.flagShare,
  ...
  factory GetProductByCategoryBanner.fromJson(Map<String, dynamic> json) =>
      GetProductByCategoryBanner(
        skucode:
            List<Skucode>.from(json["skucode"].map((x) => Skucode.fromJson(x))),
        flagShare: json["FlagShare"],
        contentimg: Img.fromJson(json["contentimg"]),
        bannerimg: Img.fromJson(json["bannerimg"]),
        pushImage: Img.fromJson(json["PushImage"]),
        popupImage: Img.fromJson(json["PopupImage"]),
      );

  Map<String, dynamic> toJson() => {
        "skucode": List<dynamic>.from(skucode.map((x) => x.toJson())),
        "FlagShare": flagShare,
        "contentimg": contentimg.toJson(),
        "bannerimg": bannerimg.toJson(),
        "PushImage": pushImage.toJson(),
        "PopupImage": popupImage.toJson(),
      };
}
