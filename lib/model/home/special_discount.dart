...
//
//     final specialDiscount = specialDiscountFromJson(jsonString);

import 'dart:convert';

SpecialDiscount specialDiscountFromJson(String str) =>
    SpecialDiscount.fromJson(json.decode(str));

String specialDiscountToJson(SpecialDiscount data) =>
