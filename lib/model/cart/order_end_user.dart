...
//
//     final orderEndUser = orderEndUserFromJson(jsonString);

import 'dart:convert';

OrderEndUser orderEndUserFromJson(String str) =>
    OrderEndUser.fromJson(json.decode(str));

String orderEndUserToJson(OrderEndUser data) => json.encode(data.toJson());

class OrderEndUser {
  OrderEndUserClass orderEndUser;
  ...
  factory OrderEndUser.fromJson(Map<String, dynamic> json) => OrderEndUser(
        orderEndUser: OrderEndUserClass.fromJson(json["OrderEndUser"]),
      );
...
class OrderEndUserClass {
  ...
  factory OrderEndUserClass.fromJson(Map<String, dynamic> json) =>
      OrderEndUserClass(
...
class OrderHeader {
  ...
  List<CouponDiscount> couponDiscount;
  String autoRun;
  ...
  factory OrderHeader.fromJson(Map<String, dynamic> json) => OrderHeader(
        ...
        couponDiscount: List<CouponDiscount>.from(
            json["CouponDiscount"].map((x) => CouponDiscount.fromJson(x))),
