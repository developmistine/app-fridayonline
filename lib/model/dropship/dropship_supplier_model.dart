...
//
//     final getDropshipProductBySupplier = getDropshipProductBySupplierFromJson(jsonString);

// import 'package:meta/meta.dart';
import 'dart:convert';

GetDropshipProductBySupplier getDropshipProductBySupplierFromJson(String str) =>
    GetDropshipProductBySupplier.fromJson(json.decode(str));

String getDropshipProductBySupplierToJson(GetDropshipProductBySupplier data) =>
    json.encode(data.toJson());

class GetDropshipProductBySupplier {
  GetDropshipProductBySupplier({
  ...
  String supplierName;
  String supplierType;
  List<Product> productPromotion;
  List<Product> productAll;

  factory GetDropshipProductBySupplier.fromJson(Map<String, dynamic> json) =>
      GetDropshipProductBySupplier(
        supplierCode: json["SupplierCode"] ?? "",
        supplierName: json["SupplierName"] ?? "",
        supplierType: json["SupplierType"] ?? "",
        productPromotion: json["ProductPromotion"] == null
            ? []
            : List<Product>.from(
                json["ProductPromotion"].map((x) => Product.fromJson(x))),
        productAll: json["ProductAll"] == null
            ? []
            : List<Product>.from(
                json["ProductAll"].map((x) => Product.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "ProductPromotion":
            List<dynamic>.from(productPromotion.map((x) => x.toJson())),
        "ProductAll": List<dynamic>.from(productAll.map((x) => x.toJson())),
      };
}
