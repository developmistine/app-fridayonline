import 'package:fridayonline/homepage/register/regiscustomerlead.dart';
...
class LeadWebviewPDPA extends StatefulWidget {
  const LeadWebviewPDPA({super.key});

  @override
  State<LeadWebviewPDPA> createState() => _LeadWebviewPDPAState();
}

class _LeadWebviewPDPAState extends State<LeadWebviewPDPA> {
