...
successConfirmDialogEndUser(context, OrderEndUser orderTotal) async {
  if (orderTotal.orderdetail.isNotEmpty ||
      orderTotal.orderdetailB2C.isNotEmpty) {
    saveDirecsale.saveOrderEndUserCart(orderTotal.toJson());
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            ...
            'เกิดข้อผิดพลาด กรุณาลองใหม่อีกครั้งค่ะ', //'บันทึกการสั่งซื้อสำเร็จ',
