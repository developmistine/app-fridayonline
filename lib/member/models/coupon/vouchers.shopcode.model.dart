...
//
//     final vouchersShopCode = vouchersShopCodeFromJson(jsonString);

import 'dart:convert';

VouchersShopCode vouchersShopCodeFromJson(String str) =>
    VouchersShopCode.fromJson(json.decode(str));

String vouchersShopCodeToJson(VouchersShopCode data) =>
    json.encode(data.toJson());

class VouchersShopCode {
  String code;
  Data data;
  String message;
  ...
  factory VouchersShopCode.fromJson(Map<String, dynamic> json) =>
      VouchersShopCode(
        code: json["code"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        shopVoucher: ShopVoucher.fromJson(json["shop_voucher"]),
      );

  Map<String, dynamic> toJson() => {
        "message_text": messageText,
        "shop_voucher": shopVoucher.toJson(),
      };
}
