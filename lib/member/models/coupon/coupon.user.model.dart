...
//
//     final voucherUser = voucherUserFromJson(jsonString);

import 'dart:convert';

VoucherUser voucherUserFromJson(String str) =>
    VoucherUser.fromJson(json.decode(str));

String voucherUserToJson(VoucherUser data) => json.encode(data.toJson());
...
class VoucherUser {
  ...
  factory VoucherUser.fromJson(Map<String, dynamic> json) => VoucherUser(
        code: json["code"],
...
class Data {
  ...
  List<VoucherSummary> voucherSummary;
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        voucherSummary: List<VoucherSummary>.from(
            json["voucher_summary"].map((x) => VoucherSummary.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "vouchers": List<dynamic>.from(vouchers.map((x) => x.toJson())),
        "voucher_summary":
            List<dynamic>.from(voucherSummary.map((x) => x.toJson())),
      };
}
