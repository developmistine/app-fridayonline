...
//
//     final homeVouchers = homeVouchersFromJson(jsonString);

import 'dart:convert';

HomeVouchers homeVouchersFromJson(String str) =>
    HomeVouchers.fromJson(json.decode(str));

String homeVouchersToJson(HomeVouchers data) => json.encode(data.toJson());
...
class HomeVouchers {
  ...
  factory HomeVouchers.fromJson(Map<String, dynamic> json) => HomeVouchers(
        code: json["code"],
