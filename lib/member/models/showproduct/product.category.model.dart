...
//
//     final productContent = productContentFromJson(jsonString);

import 'dart:convert';

ProductContent productContentFromJson(String str) =>
    ProductContent.fromJson(json.decode(str));

String productContentToJson(ProductContent data) => json.encode(data.toJson());
