...
class CacheImageBanner extends StatelessWidget {
  final String url;
  const CacheImageBanner({super.key, required this.url});
...
class CacheImageFavorite extends StatelessWidget {
  final String url;
  const CacheImageFavorite({super.key, required this.url});
...
class CacheImagePromotion extends StatelessWidget {
  final String url;
  const CacheImagePromotion({super.key, required this.url});
...
class CacheImageDiscount extends StatelessWidget {
  final String url;
  const CacheImageDiscount({super.key, required this.url});
...
class CacheImageProduct extends StatelessWidget {
  ...
  const CacheImageProduct({super.key, required this.url});
...
class CacheImagePrice extends StatelessWidget {
  ...
  const CacheImagePrice(
      {super.key, required this.url, required this.flagNetPrice});
...
class CacheImageAppend extends StatelessWidget {
  ...
  const CacheImageAppend(
      {super.key, required this.url, required this.flagInstock});
...
class CacheImageMarket extends StatelessWidget {
  final String url;
  const CacheImageMarket({super.key, required this.url});
