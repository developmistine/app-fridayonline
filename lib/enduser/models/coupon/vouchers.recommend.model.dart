...
//
//     final voucherRecommend = voucherRecommendFromJson(jsonString);

import 'dart:convert';

VoucherRecommend voucherRecommendFromJson(String str) =>
    VoucherRecommend.fromJson(json.decode(str));

String voucherRecommendToJson(VoucherRecommend data) =>
